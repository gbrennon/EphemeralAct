...
use crate::domain::value_objects::CleanupPolicy;
...
impl EphemeralRepository {
    ...
    ///
    /// ```
    /// # use ephact::domain::value_objects::{CleanupPolicy, RepoPath, RepositoryName};
    /// # use ephact::domain::{EphemeralRepository, Repository};
    /// # use std::env;
